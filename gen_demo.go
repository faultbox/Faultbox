...
func main() {
	...
	manifest := bundle.Manifest{
		...
		Tests: []bundle.TestRow{
			{Name: "test_order_flow__none", Outcome: "passed", DurationMs: 82, Seed: 7},
			{Name: "test_order_flow__db_down", Outcome: "passed", DurationMs: 110, Seed: 7, FaultAssumptions: []string{"postgres: connect=ECONNREFUSED"}},
			{Name: "test_order_flow__cache_latency", Outcome: "failed", DurationMs: 2840, Seed: 7, FaultAssumptions: []string{"redis: read=delay(500ms)"}},
			{Name: "test_order_flow__disk_full", Outcome: "passed", DurationMs: 134, Seed: 7, FaultAssumptions: []string{"fs: write=ENOSPC"}},
			{Name: "test_inventory__none", Outcome: "passed", DurationMs: 95, Seed: 7},
			{Name: "test_inventory__db_down", Outcome: "failed", DurationMs: 210, Seed: 7, FaultAssumptions: []string{"postgres: connect=ECONNREFUSED"}},
			{Name: "test_inventory__cache_latency", Outcome: "passed", DurationMs: 180, Seed: 7},
			{Name: "test_inventory__disk_full", Outcome: "passed", DurationMs: 100, Seed: 7},
			{Name: "test_checkout__none", Outcome: "passed", DurationMs: 115, Seed: 7},
			{Name: "test_checkout__db_down", Outcome: "passed", DurationMs: 140, Seed: 7},
			{Name: "test_checkout__cache_latency", Outcome: "passed", DurationMs: 200, Seed: 7},
			{Name: "test_checkout__disk_full", Outcome: "passed", DurationMs: 122, Seed: 7},
		},
		Summary: bundle.Summary{Total: 12, Passed: 10, Failed: 2, Errored: 0},
	}
...
func buildMatrix() map[string]any {
	...
	cells := []map[string]any{
		{"scenario": "order_flow", "fault": "none", "passed": true, "duration_ms": 82},
		{"scenario": "order_flow", "fault": "db_down", "passed": true, "duration_ms": 110},
		{"scenario": "order_flow", "fault": "cache_latency", "passed": false, "duration_ms": 2840, "reason": "assert_eq: request took 2.8s, expected < 1s"},
		{"scenario": "order_flow", "fault": "disk_full", "passed": true, "duration_ms": 134},
		{"scenario": "inventory", "fault": "none", "passed": true, "duration_ms": 95},
		{"scenario": "inventory", "fault": "db_down", "passed": false, "duration_ms": 210, "reason": "assert_true: response.ok was false"},
		{"scenario": "inventory", "fault": "cache_latency", "passed": true, "duration_ms": 180},
		{"scenario": "inventory", "fault": "disk_full", "passed": true, "duration_ms": 100},
		{"scenario": "checkout", "fault": "none", "passed": true, "duration_ms": 115},
		{"scenario": "checkout", "fault": "db_down", "passed": true, "duration_ms": 140},
		{"scenario": "checkout", "fault": "cache_latency", "passed": true, "duration_ms": 200},
		{"scenario": "checkout", "fault": "disk_full", "passed": true, "duration_ms": 122},
	}
